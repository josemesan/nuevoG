...
public class LogobdApp {

    private static final Logger log = LoggerFactory.getLogger(LogobdApp.class);

    private final Environment env;

    public LogobdApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LogobdApp.class);
