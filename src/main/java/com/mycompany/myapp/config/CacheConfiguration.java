...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Evento.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Fecha.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Tren.class.getName(), jcacheConfiguration);
